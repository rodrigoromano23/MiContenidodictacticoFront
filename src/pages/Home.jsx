  ...
  return (
    <div className="relative flex h-screen bg-slate-950 text-white overflow-hidden select-none">
      ...
      <div className="flex md:hidden flex-1 flex-col relative w-full h-full z-10 overflow-hidden">
        ...
        {searched && (
          <div className="fixed bottom-0 left-0 w-full bg-slate-900/85 backdrop-blur-md border-t border-white/10 px-4 py-3 z-[100] overflow-x-auto no-scrollbar flex items-center gap-5">
